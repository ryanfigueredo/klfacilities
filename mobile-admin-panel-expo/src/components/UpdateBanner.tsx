...
export default function UpdateBanner({ onDismiss, appName = 'KL Administração' }: UpdateBannerProps) {
  const handleUpdate = () => {
    if (Platform.OS === 'ios') {
      Linking.openURL('https://apps.apple.com/app/id6739522001'); // Substitua pelo ID real do app
    } else {
      Linking.openURL('https://play.google.com/store/apps/details?id=com.kl.adm');
    }
  };
